from vision.ssd.efficientnet_ssd_lite import create_efficientnet_ssd_lite_b0, create_efficientnet_ssd_lite_predictor
...
if net_type == 'ef-yolof' or net_type == "mb2-yolof" or net_type == "mb3-yolof" or net_type == "mbd-yolof":
    predictor = create_mobiledet_yolof_predictor(net, candidate_size=200)
elif net_type == 'mb1-ssd':
...
elif net_type == 'ef-ssd-b0' or net_type == 'ef-ssd-b1' or net_type == 'ef-ssd-b2':
